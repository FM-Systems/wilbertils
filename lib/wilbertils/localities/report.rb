...
module Wilbertils; module Localities
  ...
  # Collects every change an import run makes. summary_counts fits in
  # Sidekiq::Status, #to_csv is the drill-down. Subclasses declare SECTIONS
  # and ESTIMATED_IN_DRY_RUN.
  class Report
